**DevEx Alliance** - это некоммерческое объединение владельцев ключей, создаваемое на базе [Everscale Developer Experience Subgovernance](https://devex.gov.freeton.org/main).  
### Цель  
